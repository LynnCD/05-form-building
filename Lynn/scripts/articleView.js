...
articleView.create = function() {
  ...
  var renderFunc = Handlebars.compile($('#preview-template').html());// html got one element here of #preview-template
  // funtcion that returns a function/template and will be called later on.
  ...
  $('pre code').each(funciton(i,block){
    hljs.hightlightBlock(block);
  });// 'pre code: look for every code tag insde of a pre tag
     // need to add hljs CDN
